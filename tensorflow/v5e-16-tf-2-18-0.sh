...
gcloud compute tpus tpu-vm create test123 --zone=us-central1-a --version=tpu-vm-tpu-vm-tf-2.18.0-pod-pjrt-v5e-and-v6 --accelerator-type=v5litepod-16 --spot

# Setting TPU_NAME = "test123" and upload the test script
...
# You should see 16 tensor printed.